...
---
## How to Navigieren:
Im folgenden teile ich es in Handy und PC/Laptop auf. Das sollte so das meiste für den Otto-Normal Verbraucher abdecken. 
Ich habe dann versucht die großen/wichtigen Funktionalitäten abzudecken (Betriebssystem, Browser, Navigation,...)
Ich habe die Apps und Programme immer in drei Kategorien eingeteilt, womit man ungefähr einschätzen kann wie gut die App / das Programm ist. Falls eine App mal nicht open source ist, erwähne ich das explizit. Alle ohne Info sind Open Source
1. Genauso gut oder besser wie Closed Source
2. Leichte einbusen, aber immernoch auf Closed Source verzichtbar
3. Guter Anfang aber Closed Source für einige Anwendungen unverzichtbar 
---
## Handy/Smartphone
### Betriebssystem
...
- Open Reads: Schöne offline Möglichkeit seine gelesenen Bücher zu tracken
### Weiteres
...
- Acode: Ein bisschen wie VSCodium (bzw Visual Studio Code) zum bearbeiten von Code
...
### Allgemeines
- VS-Codium: Open Source Grundgerüst von Visual Studio Code, mit allen funktionen aber Open Source
---
...
- Logseq: Eine super Notizapp (als alternative zu Obsidian zb.) mit der man auch nach dem "Zettelkastenprinzip" und täglichen Journalen ein zweites Gehirn aufbauen kann. Alles ist lokal in .md dateien gespeichert, man kann sie also mit jedem Editor öffnen (falls das Programm irgendwann mal nicht mehr funktionieren sollte) und die Notizen sind in Markdown gespeichert -> eine Universelle und einfache Computersprache um Text zu formatieren. Die Dateien sind lokal gespeichert (maximaler Datenschutz) und man kann sie mit syncthing über Geräte synchronisieren
